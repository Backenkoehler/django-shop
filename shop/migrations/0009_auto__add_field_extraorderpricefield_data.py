...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_extraorderline', 'data', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Adding field 'ExtraOrderItemLine.data'
        db.add_column('shop_extraorderitemline', 'data', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'ExtraOrderLine.data'
        db.delete_column('shop_extraorderline', 'data')

        # Deleting field 'ExtraOrderItemLine.data'
        db.delete_column('shop_extraorderitemline', 'data')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtraOrderLine.modifier'
        db.add_column('shop_extraorderline', 'modifier', self.gf('django.db.models.fields.CharField')(default='unnamed_modifier', max_length=255), keep_default=False)

        # Adding field 'ExtraOrderItemLine.modifier'
        db.add_column('shop_extraorderitemline', 'modifier', self.gf('django.db.models.fields.CharField')(default='unnamed_modifier', max_length=255), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'ExtraOrderLine.modifier'
        db.delete_column('shop_extraorderline', 'modifier')

        # Deleting field 'ExtraOrderItemLine.modifier'
        db.delete_column('shop_extraorderitemline', 'modifier')
